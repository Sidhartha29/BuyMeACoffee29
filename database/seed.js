    ...
    const images = [
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/FF6B35/FFFFFF?text=Sunset+Mountains',
        thumbnail_url: 'https://via.placeholder.com/400x300/FF6B35/FFFFFF?text=Sunset+Mountains',
        price: 15.99,
        downloads: 23,
        category: 'Nature',
      ...
      },
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/4ECDC4/FFFFFF?text=Abstract+Art',
        thumbnail_url: 'https://via.placeholder.com/400x300/4ECDC4/FFFFFF?text=Abstract+Art',
        price: 22.50,
        downloads: 15,
        category: 'Abstract',
      ...
      },
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/45B7D1/FFFFFF?text=City+Architecture',
        thumbnail_url: 'https://via.placeholder.com/400x300/45B7D1/FFFFFF?text=City+Architecture',
        price: 18.99,
        downloads: 28,
      ...
      },
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/96CEB4/FFFFFF?text=Street+Scene',
        thumbnail_url: 'https://via.placeholder.com/400x300/96CEB4/FFFFFF?text=Street+Scene',
        price: 12.50,
        downloads: 18,
        category: 'Street',
      ...
      },
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/FECA57/FFFFFF?text=Portrait+Study',
        thumbnail_url: 'https://via.placeholder.com/400x300/FECA57/FFFFFF?text=Portrait+Study',
        price: 25.00,
        downloads: 7,
        category: 'Portrait',
      ...
      },
      {
        ...
        image_url: 'https://via.placeholder.com/1200x800/FF9FF3/FFFFFF?text=Forest+Path',
        thumbnail_url: 'https://via.placeholder.com/400x300/FF9FF3/FFFFFF?text=Forest+Path',
        price: 18.75,
        downloads: 31,
        category: 'Nature',
        created_at: new Date('2024-04-10'),
